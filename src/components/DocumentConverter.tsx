                   ...
                   <button
                     ...
                     onClick={() => {
                       ...
                       setTimeout(() => {
                         ...
                         setExtractedCards(mapped);
                         setSuccessCount(mapped.length);
                         pushLog(`🎉 Đã nạp thành công ${mapped.length} thẻ học phần do mày vừa nhập thủ công.`);
                         setIsProcessing(false);
                         setProgressText("");
            ...
            >
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-stone-500 dark:text-zinc-400 max-w-sm mx-auto leading-relaxed">
                  Nếu luồng tự động của vệ tinh AI bị nghẽn mạch hoặc vượt quá giới hạn tài nguyên, mày có thể bóc tách thủ công siêu tốc và cực kỳ chuẩn xác bằng hai phương án dưới đây.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[10px] text-stone-500 dark:text-zinc-400 mt-1.5 leading-relaxed">
                      Hệ thống tự động sao chép prompt tối ưu dán sẵn vào khay bộ nhớ đệm (Clipboard) rồi định tuyến mày sang Gemini Web để nhận phản hồi JSON có ngay lập tức.
                    </p>
                  </div>
                </div>
              </div>
