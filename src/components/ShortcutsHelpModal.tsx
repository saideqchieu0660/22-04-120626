...
export function ShortcutsHelpModal({ isOpen, onClose }: ShortcutsHelpModalProps) {
  ...
  const shortcutsList = [
    ...
    { key: "R", desc: "Xem Bảng Xếp Hạng tuần (Leaderboard khốc liệt)", icon: <Trophy className="w-4 h-4 text-yellow-500" /> },
    ...
    { key: "A", desc: "Xem Kho Thành Tựu & Huy chương rực lửa", icon: <Award className="w-4 h-4 text-amber-500" /> },
    { key: "P", desc: "Xem Cài đặt trang cá nhân của mày (Profile)", icon: <User className="w-4 h-4 text-blue-500" /> },
    { key: "M", desc: "Biểu đồ thông thạo & Heatmap chuyên sâu (Chart & Stats)", icon: <Sliders className="w-4 h-4 text-stone-400" /> },
    { key: "S", desc: "Mở/Đóng nhanh Menu Cài đặt hệ sinh thái", icon: <Sliders className="w-4 h-4 text-amber-500 animate-pulse" /> },
  ...
  return (
    <div id="shortcuts-modal-overlay" className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div 
        ...
        className="fixed inset-0 bg-stone-950/80 dark:bg-black/95 backdrop-blur-md cursor-pointer"
        onClick={onClose}
      />
      ...
      <motion.div
        ...
        className="relative w-full max-w-3xl h-[650px] max-h-[92vh] bg-stone-900 border border-stone-800 dark:bg-zinc-950 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.85)] flex flex-col font-sans text-stone-100"
      >
        ...
        <div className="flex items-center justify-between px-8 py-5 border-b border-stone-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-stone-400 font-medium font-sans">Bí kíp rèn kỷ luật và làm chủ hệ thống Henosis Web của mày</p>
            </div>
          </div>
          <button 
            id="close-shortcuts-modal-header"
            onClick={onClose}
            className="p-2 text-stone-400 hover:text-white hover:bg-stone-800/80 rounded-xl transition-all duration-200 cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="p-5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
                  ...
                  <div className="text-xs text-stone-300 leading-relaxed font-sans space-y-2">
                    <p>
                      Mày thấy hiệu ứng lướt card hoặc mây trôi rực rỡ ở phòng học Cyberpunk bị chậm, đơ đơ? Đúng rồi, do phần cứng GPU/RAM của mày đang quá tải hiệu ứng đồ họa cao cấp của tao đấy!
                    </p>
                    <div className="bg-stone-950/50 p-3 rounded-xl border border-stone-800 mt-2">
                      ...
                      <ul className="list-disc pl-5 space-y-1 text-stone-400">
                        <li>Ấn phím <kbd className="px-1.5 py-0.5 font-mono text-yellow-500 bg-yellow-500/10 border border-yellow-500/20 rounded">E</kbd> trên bàn phím để kích hoạt ngay <strong>Chế Độ Mượt (Eco Mode)</strong>.</li>
                        <li>Hoặc ấn phím <kbd className="px-1.5 py-0.5 font-mono text-yellow-500 bg-yellow-500/10 border border-yellow-500/20 rounded">S</kbd> mở menu cài đặt, sau đó bật thủ công nút gạt <strong>Chế độ Mượt (Eco Mode / Fix Lag)</strong>.</li>
                        <li>Ngay lập tức, hệ thống sẽ tắt sạch hiệu ứng tuyết rơi, các hạt canvas nền động lững lờ, giảm độ phân giải chuyển cảnh phức tạp. Trả lại cho mày một giao diện tĩnh mướt rượt, tải siêu nhanh và tiết kiệm pin tối đa!</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
                  ...
                  <div className="text-xs text-stone-300 leading-relaxed font-sans space-y-2">
                    <p>
                      Đừng để mỏi mắt phá vỡ nhịp điệu học tập của mày. Tao đã tích hợp bộ zoom giao diện thông minh ngay trong tầm tay.
                    </p>
                    <div className="bg-stone-950/50 p-3 rounded-xl border border-stone-800">
                      ...
                      <ul className="list-disc pl-5 space-y-1 text-stone-400">
                        <li>Ấn phím <kbd className="px-1.5 py-0.5 font-mono text-yellow-500 bg-yellow-500/10 border border-yellow-500/20 rounded">S</kbd> để kéo trực tiếp menu cài đặt từ góc phải màn hình.</li>
                        <li>Tại mục <strong>Cỡ Chữ (Font Zoom)</strong>, mày kéo thanh trượt Slider để tùy chỉnh kích thước mong muốn (từ nhỏ gọn 80% đến siêu to 130%).</li>
                ...
                <div className="p-5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 bg-stone-900/40 border border-stone-800 rounded-xl space-y-1">
                      <span className="text-yellow-500 font-display font-black text-xs block flex items-center gap-1.5">
                        <Trophy className="w-3.5 h-3.5" /> 🏆 Leaderboard (Bảng Xếp Hạng)
                      </span>
                      <p className="text-stone-400 text-[11px] leading-relaxed">
                        Nơi tranh tài vương quyền của đấu trường học tập. Mỗi khi mày ôn luyện thẻ, vượt qua các câu hỏi trắc nghiệm, tạo tài liệu hoặc tương tác với Socrates AI, mày đều được cộng điểm XP. Bảng xếp hạng sẽ tự động cập nhật realtime để vinh danh Top 3 kèm vầng hào quang rực rỡ nhất tuần!
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-stone-900/40 border border-stone-800 rounded-xl space-y-1">
                      ...
                      <p className="text-stone-400 text-[11px] leading-relaxed">
                        Bản đồ rèn luyện kỷ luật Stoicism độc nhất vô nhị. Mày không phải học một cách vô hướng, mà rẽ nhánh mở khóa các kỹ năng từ cơ bản đến thượng thừa nhờ lượng từ vựng và chủ đề học tích lũy. Mối nhánh kỹ năng tương ứng với thông số học tập thực của chính bộ thẻ mày đang sở hữu.
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-stone-900/40 border border-stone-800 rounded-xl space-y-1">
                      ...
                      <p className="text-stone-400 text-[11px] leading-relaxed">
                        Góc cá tính của riêng mày! Cập nhật avatar siêu nhanh thông qua Canvas chuyển đổi ảnh thông minh, thay đổi biệt hiệu phong cách, và theo dõi bộ sưu tập <strong>Huy Chương Thành Tựu</strong> danh giá ghi dấu cam kết học tập trọn đời của mày.
                      </p>
                    </div>

                    <div className="p-3 bg-stone-900/40 border border-stone-800 rounded-xl space-y-1 md:col-span-2">
                      ...
                      <p className="text-stone-400 text-[11px] leading-relaxed">
                        Đọc vị tiến trình của mày qua số liệu thực: <strong>Biểu đồ bong bóng XP phân bổ</strong> trực quan hóa những ngách kiến thức mày đang thống trị. Kèm theo là <strong>Stoic Heatmap Lịch Sử</strong> ghi nhận chi tiết tần suất học tập mỗi ngày. Hãy tô xanh tất cả các ngày, đừng cho phép bản thân để đứt chuỗi phong độ (Streak)!
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {activeSubTab === "engine" && (
              ...
              >
                ...
                <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-stone-405">Kiến trúc cân bằng tải, xoay vòng khóa API và cơ chế miễn nhiễm lỗi 403/404</p>
                    </div>
                  </div>
                  
                  <div className="text-xs text-stone-300 leading-relaxed font-sans space-y-3">
                    <p>
                    ...
                    <p>
                      Khi mày nộp văn bản lớn, tài liệu học thuật hoặc ảnh chụp, hệ thống sẽ tự động bẻ sườn và vận hành thông qua các công nghệ cốt lõi sau:
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                    <div className="p-4 bg-stone-900/80 border border-stone-800 rounded-xl space-y-2">
                      ...
                      <p className="text-[11px] text-stone-400 leading-relaxed">
                        Tài liệu của mày dài hàng trăm trang? United Engine sẽ tự động chia nhỏ mỏng văn bản thành từng phần hợp lý (Slices) khớp khít với dung lượng <strong>Context Window</strong> của AI Model mà không làm gãy ngữ cảnh của từ vựng hay đoạn hội thoại, triệt tiêu lỗi mất mát thông tin.
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-stone-900/80 border border-stone-800 rounded-xl space-y-2">
                      ...
                      <p className="text-[11px] text-stone-400 leading-relaxed">
                        Công nghệ đột phá của phiên bản V8.0! Khi gọi OpenRouter gặp lỗi tài khoản trả phí buộc (402, 403, 404, hoặc bị ngừng hỗ trợ tài khoản miễn phí), United Engine tự động nhận diện thông qua bộ lọc thông minh, thực thi **Silent Bypass**. Hệ thống không ném lỗi ra màn hình gây gián đoạn cho mày, mà lặng lẽ chuyển sang luồng dự bị mượt mà!
                      </p>
                    </div>
                ...
                {/* Stoic Quote Footer */}
                <div className="text-center italic text-stone-500 text-[10px] uppercase font-bold tracking-wider font-sans">
                  "Chất lượng trí tuệ của mày sẽ phụ thuộc hoàn toàn vào mức độ tích lũy bền bỉ và sự tập trung của mày qua từng ngày" — Marcus Aurelius
                </div>
              </motion.div>
            )}
          </AnimatePresence>
        ...
        <div className="px-8 py-4 bg-stone-950 dark:bg-black/40 border-t border-stone-800 flex justify-between items-center text-xs shrink-0">
          <span className="text-stone-500 font-mono text-[10px] uppercase font-bold">
            💡 Mẹo Stoic: Ấn phím <kbd className="px-1.5 py-0.5 bg-stone-800 text-stone-300 border border-stone-700 rounded text-[9px] font-mono">?</kbd> để đóng nhanh cẩm nang này
          </span>
          <button
            id="close-shortcuts-modal-footer"
            onClick={onClose}
            className="px-5 py-2 rounded-xl bg-yellow-500 hover:bg-yellow-600 text-stone-950 font-black transition-transform active:scale-95 shadow-md flex items-center gap-1.5 cursor-pointer"
          >
            Đã Hiểu, Chiến Tiếp!
          </button>
        </div>
