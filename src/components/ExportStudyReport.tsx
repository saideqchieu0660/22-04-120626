        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1 flex-1">
            ...
            <p className="text-xs text-stone-600 dark:text-stone-400 leading-relaxed">
              In danh sách từ vựng/học liệu cần ôn tập gấp hoặc kết xuất báo cáo thông thạo của mày để học ngoại tuyến.
            </p>
            ...
            <div className="p-6 bg-gradient-to-r from-amber-500/10 to-yellow-500/5 border-b border-stone-200 dark:border-zinc-800 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-stone-500 dark:text-stone-400 mt-1">
                  Mày có thể chọn in toàn bộ báo cáo tổng hợp hoặc gom riêng các thẻ học yếu nhất để in danh sách gấp.
                </p>
              </div>
              <button 
                ...
                <div className="space-y-3 pt-4 border-t border-stone-150 dark:border-zinc-800">
                  ...
                  {weakCards.length > 0 ? (
                    ...
                    <div className="p-8 text-center text-xs text-stone-400 dark:text-zinc-500 flex flex-col items-center justify-center gap-2">
                      ...
                      <span>Không tìm thấy từ vựng hay thẻ học nào bị phân loại yếu! Điểm số thông thạo của mày cực kỳ tuyệt vời.</span>
                    </div>
                  )}
                </div>
